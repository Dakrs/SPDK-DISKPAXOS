...
sudo ./Reset --processes 8 --lanes 10 --proposals $((PROPOSALS * 10)) --diskid nqn.2016-06.io.spdk:cnode1 --port 4421 --subnqn nqn.2016-06.io.spdk:cnode1
sudo ./Reset --processes 8 --lanes 10 --proposals $((PROPOSALS * 10)) --diskid nqn.2016-06.io.spdk:cnode2 --port 4422 --subnqn nqn.2016-06.io.spdk:cnode2
sudo ./Reset --processes 8 --lanes 10 --proposals $((PROPOSALS * 10)) --diskid nqn.2016-06.io.spdk:cnode3 --port 4423 --subnqn nqn.2016-06.io.spdk:cnode3
...
(sudo ./DiskPaxos_SimpleProcess --processes 8 --lanes 10 --pid 0 --cpumask 0x4) &
#(sudo ./DiskPaxos_SimpleProcess --processes 8 --lanes 10 --pid 1 --cpumask 0x8) &
