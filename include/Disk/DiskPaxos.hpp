...
namespace DiskPaxos {
  ...
  void propose_strip(int pid,int slot,std::vector<std::string>& commands);
  ...
  std::future<std::unique_ptr<std::map<int,DiskBlock>> > read_proposals_strip(int k,int number_of_slots);
